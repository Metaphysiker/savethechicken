...
{
    public class BlackListedPersonSearcher : IModelSearcher<BlackListedPerson, BlackListedPersonSearch>
    {
        private readonly DatabaseContext _db;
        public BlackListedPersonSearcher(DatabaseContext db)
        {
            _db = db;
        }

        public async Task<PaginationDto<BlackListedPerson>> SearchAsync(BlackListedPersonSearch search, params Expression<Func<BlackListedPerson, object?>>[] includes)
        {
            ...
            return new PaginationDto<BlackListedPerson>
            {
                Data = items,
                TotalItems = total,
                Page = page,
