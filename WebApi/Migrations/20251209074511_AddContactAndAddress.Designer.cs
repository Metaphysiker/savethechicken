...
namespace WebApi.Migrations
{
    ...
    [Migration("20251209074511_AddContactAndAddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApi.Classes.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApi.Classes.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebApi.Models.ModelsImpl.SaveChickenRequest", b =>
                {
                    b.HasOne("WebApi.Classes.Address", "AddressForHandOver")
                        .WithMany()
                        .HasForeignKey("AddressForHandOverId");

                    b.HasOne("WebApi.Classes.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApi.Classes.Contact", "Contact")
                        .WithMany()
